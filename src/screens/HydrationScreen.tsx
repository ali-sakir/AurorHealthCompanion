        ...
        <View style={styles.content}>
          ...
          <View style={[styles.card, Shadow.card]}>
            ...
            <View style={styles.progressRow}>
              ...
              <Text style={styles.remaining}>💧 {Math.max(DAILY_GOAL - glasses, 0)} remaining</Text>
            </View>
          </View>
          ...
          <View style={[styles.card, Shadow.card]}>
            ...
            <View style={styles.glassRow}>
              {[...Array(DAILY_GOAL)].map((_, i) => (
                <Text key={i} style={styles.glassIcon}>{i < glasses ? "🥛" : "⬜"}</Text>
              ))}
            </View>
...
const styles = StyleSheet.create({
  ...
  glassRow: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", marginBottom: 12 },
  glassIcon: { fontSize: 30, margin: 4 },
  ...
  resetButton: { borderRadius: Radius.md, paddingVertical: 16, alignItems: "center", marginBottom: 20, borderWidth: 1.5, borderColor: Colors.danger, backgroundColor: Colors.danger + "11" },
